...
function Docs({ docName, author, createdAt, docId, partager, owner }) {
            ...
            <div class="flex items-end sm:items-center justify-center min-h-full p-4 text-center sm:p-0">
              <div class="relative bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:max-w-xs sm:w-full">
                <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                  <h3
                    class="text-lg leading-6 font-medium text-gray-900 mb-3 capitalize "
                    id="modal-title"
                  >
                    <i class="fa-solid fa-marker text-blue-400 pr-2"></i>
                    modifier le doc
                  </h3>
                  <input
              ...
              <div class="relative bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:max-w-sm sm:w-full">
                <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                  <h3
                    ...
                    id="modal-title"
                  >
                    <i class="fa-solid fa-circle-exclamation text-red-400 pr-2"></i>
                    suppresion du doc
                  </h3>
                  <p className="text-gray-500">
                    vous etes sure que vous voulez supprimer ce doc
                  </p>
                </div>
                <div class="bg-gray-50 px-4 py-3  sm:px-6 sm:flex sm:flex-row-reverse place-content-center">
                  <button
                    onClick={() => deleteDoc()}
                    class="px-8 button button-red font-bold"
                    data-ripple-light="true"
                  >
                    Oui
                  </button>
  ...
  return (
    <>
      {deleteModal()}
      {updateModal()}
      <div className=" rounded-full hover:bg-blue-100  ease-in duration-200 hover:scale-[1.02] ">
        <div className="flex items-center justify-between px-5 py-1 mt-3  rounded-full cursor-pointer">
          ...
          >
            ...
            <h1 className="text-gray-700 mr-5 lg:mr-10 w-20 md:w-20">
              {docName}
            </h1>
          ...
          <div
            ...
            className="flex items-center "
          >
            <h1 className="px-10 lg:px-20 text-gray-600">
              {author} {partager && "et d'autre"}
            </h1>
            <h1 className="px-10 lg:px-20 text-gray-500 tracking-widest text-sm">
          ...
          <div className="">
            {!disabled ? (
              <button
                ...
                className="button button-text rounded-full  text-gray-500 hover:text-blue-500 hover:bg-white my-1 px-3 py-1 p-3 text-lg"
            ...
            {!disabled ? (
              <button
                ...
                className="button button-text rounded-full text-gray-500 hover:text-red-500 hover:bg-white my-1 px-3 py-1 p-3 text-lg"
                data-ripple-dark="true"
              >
