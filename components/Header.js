...
export default function Header({ children }) {
  ...
  const image =
    user?.photoURL ||
    "https://www.vertmondeong.com/image/commentaire/personne7.png"
  ...
  let modalProfile = () => {
    if (showModalProfile == true) {
      if (user) {
        return (
          <div class="w-80 h-96 fixed z-20 top-16 right-5 bg-[#FFFFFF] border border-black-900 shadow-md rounded-lg">
            <div className="grid justify-center px-4 pt-4 ">
              <div className="inline-flex place-content-center p-2">
                ...
                />
                <i class="fa-solid fa-camera absolute p-1 bg-white border  rounded-full right-28 top-24 shadow-md text-gray-600"></i>
              </div>
              <div className="text-center  ">
                ...
                <div className=" border  hover:bg-gray-100 cursor-pointer  rounded-full  border-gray-300  p-2 my-5 mx-2 ">
                  {" "}
                  <p className="capitalize text-sm ">
                    gerer votre compte google
                  </p>{" "}
                </div>
              </div>
            </div>
        ...
        return (
          <div class="w-80 h-32 fixed z-20 top-16 right-5 bg-[#FFFFFF] border border-black-900 shadow-md rounded-lg">
      ...
      {showNavBar && (
        <div className="top-0 flex p-1 justify-between shadow-md items-center bg-white px-3">
          ...
          <div className="p-1 rounded-lg bg-gray-100 flex flex-auto mx-1 md:mx-16 lg:mx-48">
            <div class="rounded-full hover:bg-gray-200 px-3 py-2 cursor-pointer ">
            ...
            <input
              ...
              className="bg-transparent mx-3 focus:border-0 w-full text-gray-500 text-md outline-none"
            />
          </div>

          <div className="flex "></div>
          <div class="rounded-full hover:bg-gray-100  px-4  py-3 mr-2 cursor-pointer hidden md:block">
